            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_title sign-up-direction ">
                        <h2><spring:message code="sponsoreShipType.add.pageheader" /></h2>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <form:form id="demo-form2" method="post" class="form-horizontal form-label-left" modelAttribute="sponsoreShipType">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <input type="submit" class="btn btn-success" value="<spring:message code="sponsoreShipType.create" />"></input>
                                </div>
                            </div>
