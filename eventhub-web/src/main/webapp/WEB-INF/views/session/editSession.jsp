                    ...
                    <div class="x_content">
                        ...
                        <form:form id="demo-form2" method="post" class="form-horizontal form-label-left" modelAttribute="session" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <form:input path="longDescription" type="text" id="longDescription" name="shortDescription" required="required" class="form-control col-md-7 col-xs-12"></form:input>
                                    </div>
                                </div>    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <form:password path="startDate" type="datetime-local"  id="startDate" name="startDate" required="required" class="form-control col-md-7 col-xs-12"></form:password>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <form:password path="endDate" type="datetime-local"  id="endDate" name="endDate" required="required" class="form-control col-md-7 col-xs-12"></form:password>
                                    </div>
                                </div>        
