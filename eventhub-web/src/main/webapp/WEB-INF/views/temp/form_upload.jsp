...
<head>
    ...
    <!-- Dropzone.js -->
    <link href="${contextPath}/resources/vendors/dropzone/dist/min/dropzone.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="form_upload" class="dropzone"></form>
                    <br />
                    <br />
                    <br />
                    <br />
    ...
    <!-- Dropzone.js -->
    <script src="${contextPath}/resources/vendors/dropzone/dist/min/dropzone.min.js"></script>
