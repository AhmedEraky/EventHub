...
<head>
    ...
    <link href="${contextPath}/resources/vendors/bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.css" rel="stylesheet">
    <!-- Ion.RangeSlider -->
    <link href="${contextPath}/resources/vendors/normalize-css/normalize.css" rel="stylesheet">
    <link href="${contextPath}/resources/vendors/ion.rangeSlider/css/ion.rangeSlider.css" rel="stylesheet">
    <link href="${contextPath}/resources/vendors/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css" rel="stylesheet">
    <!-- Bootstrap Colorpicker -->
    <link href="${contextPath}/resources/vendors/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet">

    <link href="${contextPath}/resources/vendors/cropper/dist/cropper.min.css" rel="stylesheet">
...
<div class="x_panel" style="">
    ...
    <!-- bootstrap-datetimepicker -->    
    <script src="${contextPath}/resources/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
    <!-- Ion.RangeSlider -->
    <script src="${contextPath}/resources/vendors/ion.rangeSlider/js/ion.rangeSlider.min.js"></script>
    <!-- Bootstrap Colorpicker -->
    <script src="${contextPath}/resources/vendors/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
    <!-- jquery.inputmask -->
    <script src="${contextPath}/resources/vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
    <!-- jQuery Knob -->
    <script src="${contextPath}/resources/vendors/jquery-knob/dist/jquery.knob.min.js"></script>
    <!-- Cropper -->
    <script src="${contextPath}/resources/vendors/cropper/dist/cropper.min.js"></script>
