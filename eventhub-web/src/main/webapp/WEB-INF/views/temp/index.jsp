...
<head>
  ...
  <link rel="icon" href='${contextPath}/resources/images/img.jpg' type="image/ico" />
  ...
  <link href="${contextPath}/resources/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
...
<body class="nav-md">
    ...
    <!-- gauge.js -->
    <script src="${contextPath}/resources/vendors/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    <script src="${contextPath}/resources/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <!-- iCheck -->
    <script src="${contextPath}/resources/vendors/iCheck/icheck.min.js"></script>
    <!-- Skycons -->
    <script src="${contextPath}/resources/vendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="${contextPath}/resources/vendors/Flot/jquery.flot.js"></script>
    <script src="${contextPath}/resources/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="${contextPath}/resources/vendors/Flot/jquery.flot.time.js"></script>
    <script src="${contextPath}/resources/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="${contextPath}/resources/vendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="${contextPath}/resources/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="${contextPath}/resources/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="${contextPath}/resources/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <%--<script src="${contextPath}/resources/vendors/DateJS/build/date.js"></script>--%>
    <!-- JQVMap -->
    <script src="${contextPath}/resources/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="${contextPath}/resources/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="${contextPath}/resources/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
