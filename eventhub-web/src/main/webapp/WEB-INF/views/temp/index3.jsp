...
<body class="nav-md">
    ...
    <!-- jQuery Sparklines -->
    <script src="${contextPath}/resources/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
    <!-- morris.js -->
    <script src="${contextPath}/resources/vendors/raphael/raphael.min.js"></script>
    <script src="${contextPath}/resources/vendors/morris.js/morris.min.js"></script>
    <!-- gauge.js -->
