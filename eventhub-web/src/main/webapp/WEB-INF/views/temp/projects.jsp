            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="${contextPath}/resources/images/img.jpg" alt="${contextPath}/resources." class="img-circle profile_img">
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="list-inline">
                                                <li>
                                                    <img src="${contextPath}/resources/images/user.png" class="avatar" alt="Avatar">
                                                </li>
                                                <li>
                                                    <img src="${contextPath}/resources/images/user.png" class="avatar" alt="Avatar">
                                                </li>
